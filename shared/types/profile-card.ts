...
export type SkillCategory =
  ...
  | 'communication' // Writing, presentation, languages
...
export interface ProfileStrength {
  ...
  sections: {
    identity: { score: number; maxScore: number; missing: string[] };
    skills: { score: number; maxScore: number; missing: string[] };
    projects: { score: number; maxScore: number; missing: string[] };
    availability: { score: number; maxScore: number; missing: string[] };
  };
 ...
 */
export const PROFILE_CARD_ACTIONS: Record<string, CardAction> = {
  edit: {
    id: 'edit',
    label: 'Edit Profile',
    icon: 'edit',
